  ...
  return (
    <footer className="bg-black text-white py-10">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div>
          <img src="/_logo.svg" alt="Gelato Logo" className="w-24 mb-4" />
        </div>
        ...
        <div className="lg:flex lg:justify-between lg:space-x-8">
          ...
          <div className="lg:w-1/4 space-y-4">
            ...
            <button className="bg-white text-black py-2 px-4 rounded-full mt-4">
              Get started
            </button>
            {/* App Store and Google Play Icons */}
            <div className="flex space-x-4 mt-6">
              <a href="#">
                <img src="/applestore.svg" alt="App Store" className="w-24" />
              </a>
              <a href="#">
                <img src="/playstore.svg" alt="Google Play" className="w-24" />
              </a>
            </div>
          </div>
